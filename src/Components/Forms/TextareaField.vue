<template>
    <div :class="{'form-group': group}">
        ...
        <slot name="control" :type="type" :id="id" :value="value" :placeholder="placeholder" :required="required" :readonly="readonly" :pattern="pattern" :class="controlClasses">
            <textarea :id="id" :value="value" :placeholder="placeholder" :required="required" :readonly="readonly" :pattern="pattern" :class="controlClasses" v-on:input="updated($event.target.value)"></textarea>
        </slot>
